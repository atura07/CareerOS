...
export function EmptyState({ onAdd }: EmptyStateProps) {
  return (
    ...
    >
      ...
      <h3 className="text-lg font-semibold text-white/70">No applications found</h3>
      <p className="mt-1 max-w-sm text-center text-sm text-white/40">
        There are no applications matching your current search or filter. Try adjusting
        your criteria or add a new application.
      </p>
      {onAdd && (
        <button
          onClick={onAdd}
