...
export function GitHubScoreCard({ data }: GitHubScoreCardProps) {
  return (
    <motion.div
    ...
    >
      <div className="mb-3 flex items-center gap-3">
        <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-slate-400/14 ring-1 ring-slate-400/20">
      ...
      <div className="flex items-center justify-between">
        <ProgressRing
          ...
          label={`${data.score}`}
          sublabel="score"
          gradientId="githubScoreGradient"
          colorFrom="#cbd5e1"
          colorTo="#64748b"
        />
