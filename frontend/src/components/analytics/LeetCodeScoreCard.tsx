...
interface LeetCodeScoreCardProps {
  data: PlacementStatCard
}

export function LeetCodeScoreCard({ data }: LeetCodeScoreCardProps) {
  return (
    <motion.div
    ...
    >
      <div className="mb-3 flex items-center gap-3">
        <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-amber-500/14 ring-1 ring-amber-500/20">
      ...
      <div className="flex items-center justify-between">
        <ProgressRing
          ...
          label={`${data.score}`}
          sublabel="score"
          gradientId="leetcodeScoreGradient"
          colorFrom="#fbbf24"
          colorTo="#f97316"
        />
